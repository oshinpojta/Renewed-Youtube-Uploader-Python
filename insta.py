...
print(title)
os.system("cd c:\\users\\Ritesh\\desktop\\python reddit youtube")   #move to video file location
os.system("del /f /q C:\\Users\\Ritesh\\AppData\\Local\\Instaloader\\session-sam.15_06")        #delete session file bcoz its causing error
...
# folder path
dir_path = 'C:\\Users\\Ritesh\\Desktop\\Python Reddit Youtube'
